...
const currenttripRoutes = require('./routes/currenttrip')
const completedtripsRoutes = require('./routes/completedtrips')
...
app.use('/currenttrip', currenttripRoutes)
app.use('/completedtrips', completedtripsRoutes)
